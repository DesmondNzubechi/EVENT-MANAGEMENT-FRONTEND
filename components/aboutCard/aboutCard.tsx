      ...
      <div className="grid grid-cols-1 gap-[100px] lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-[30px] max-w-[600px]">
          ...
          <p className="text-gray-700 font-medium text-[12px] md:text-[15px]">
            With our expertise in event management, we provide a one-stop
            solution for all your booking needs. From concerts to corporate
            gatherings, our platform is designed to make event organization
            simple, efficient, and enjoyable. Join thousands of satisfied
            customers who trust us to make their events unforgettable.
          </p>
          <p className="text-gray-700 font-medium text-[12px] md:text-[15px]">
            Experience the ease of managing your events with our cutting-edge
            tools. From booking venues to sending invitations, we’re here to
            ensure everything runs smoothly, so you can focus on creating
            memories.
          </p>
        </div>
      </div>
