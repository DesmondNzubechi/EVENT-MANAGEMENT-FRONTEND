  ...
  return (
    <nav className={`${poppins.className} hidden lg:flex  relative z-[100]`}>
      <TfiArrowCircleUp
        ...
        className={`bg-blue-500 shadow-2xl fixed ${
      ...
      <div
        ...
        className={`py-[10px]  px-[30px] flex flex-col gap-y-[10px] shadow fixed left-0 right-0 top-0 w-full ${
        ...
        <div className="flex justify-between px-[50px] ">
          ...
          {user ? (
            <div className="flex my-[20px] flex-row items-center gap-2">
              <Link
                href="/my-account"
                className="bg-slate-900 text-primary text-light text-[15px] w-fit  py-[10px] rounded px-[20px] flex items-center gap-2"
              >
                <FaCircleUser /> My Account
              </Link>
            </div>
          ) : (
            <div className="flex my-[20px] flex-row items-center gap-2">
              <Link
                href="/auth/register"
                className="bg-slate-900 rounded text-slate-50 text-center text-light text-[15px] min-w-[150px] py-[5px] px-[20px]"
              >
                Register
              </Link>
              <Link
                href="/auth/signin"
                className="text-[15px] rounded bg-primaryBg text-center border py-[5px] min-w-[150px] px-[20px]"
              >
                Login
              </Link>
            </div>
