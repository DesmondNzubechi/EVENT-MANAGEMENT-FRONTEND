        ...
        <span onClick={(e: React.MouseEvent<HTMLSpanElement>) => {
            if (e.target instanceof HTMLElement && e.target.classList.contains("logout-dialog")) {
              setLogOut(false);
                 ...
                 {loading? <div className="flex flex-col items-center justify-center  bg-white font-poppins rounded p-[50px] relative gap-5"> <BounceLoader color="#0000FF" size={100} /> </div> : <div className="flex flex-col items-center justify-center  bg-white font-poppins rounded p-[50px] relative gap-5">
