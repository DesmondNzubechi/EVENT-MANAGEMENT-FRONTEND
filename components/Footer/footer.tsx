          ...
          <div className="flex flex-col lg:col-span-2 gap-1">
            <Link href="/" className="flex  gap-1 items-center">
              <div className="flex items-center relative z-[10] gap-1">
                ...
                <h1
                  className={`text-[19.05px] uppercase leading-[21.43px] font-[700] text-slate-50  `}
                >
                  UEvents
                </h1>
              </div>
            ...
            <p>
              At EventMaster, we specialize in connecting you with the perfect
              venue, services, and tools to host extraordinary events. Let’s
              make your vision a reality!
            </p>
          </div>
          <div className="flex flex-col gap-1">
            <h1 className="font-bold text-[25px] capitalize mb-[5px]">
              Company
            </h1>
            <div className="flex flex-col gap-2">
              <Link className="text-slate-300 text-[15px]" href="/">
                Home
              </Link>
              <Link className="text-slate-300 text-[15px]" href="/about">
                About Us
              </Link>
